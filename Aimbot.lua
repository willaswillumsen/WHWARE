--[[
    ...
    Aimbot Module [WHWARE] by WillasWillumsen © CC0 1.0 Universal (2023)

    https://github.com/WillasWillumsen
...
if not getgenv().WHWARE or getgenv().WHWARE.Aimbot then return end
...
local Environment = getgenv().WHWARE.Aimbot
...
function Environment.Functions:Exit()
    ...
    getgenv().WHWARE.Aimbot.Functions = nil
    getgenv().WHWARE.Aimbot = nil
